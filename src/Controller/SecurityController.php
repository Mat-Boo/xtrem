...
/*             'partner' => $partner,
    ...
    #[Route(path: '/api/connected-user/edit', name: 'api_connected_user_edit', methods: ['POST'])]
    ...
    #[Route(path: '/api/connected-user/modify-password', name: 'api_connected_user_modify_password', methods: ['POST'])]
