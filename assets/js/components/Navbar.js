...
export default function Navbar() {
    ...
    return (
        <nav className='navbar'>
            <NavLink to={user && user.hasCreatedPwd ? '/accueil' : (user && !user.hasCreatedPwd ? '#' : '/')}>
                <img src={WhiteLogo} alt='logo' className='logoNav' onClick={user && user.hasCreatedPwd ? (e) => hideMiniMenu(e) : null} />
            </NavLink>
            {
                user && user.hasCreatedPwd &&
                <>
