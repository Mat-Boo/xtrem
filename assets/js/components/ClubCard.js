...
export default function ClubCard({ partner, id, name, logo, isActive, address, zipcode, city, firstname, lastname, phone, email }) {
    return (
                    ...
                    <ul className='permissionsList'>
                        {
                            partner.partnerPermissions
                                .filter((partnerPermission) => partnerPermission.isActive === true)
                                .map((partnerPermission) => (
