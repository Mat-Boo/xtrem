...
export default function resetPassword() {
    ...
    const validForm = (e) => {
        ...
        .then(response => {
            ...
            stockAlertMessageInStore({type: 'success', content: 'Le mot de passe de ' + response.data.manager.firstname + ' ' +  response.data.manager.lastname + ', manager du club ' + response.data.name + ', a été modifié avec succès.'})
