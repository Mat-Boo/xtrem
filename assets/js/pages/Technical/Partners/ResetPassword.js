...
export default function resetPassword() {
    ...
    const validForm = (e) => {
        ...
        .then(response => {
            ...
            stockAlertMessageInStore({type: 'success', content: 'Le mot de passe de ' + response.data.contact.firstname + ' ' +  response.data.contact.lastname + ', contact du partenaire ' + response.data.name + ', a été modifié avec succès.'})
